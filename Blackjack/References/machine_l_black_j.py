    ...
    def play(self, rounds=1000):
        for i in range(rounds):
            ...
            for s in self.player_states:
                self.player_state_value[s] = (
                    0
                    if self.player_state_value.get(s) is None
                    else self.player_state_value.get(s)
                )
...
if __name__ == "__main__":
    ...
    x1 = [k[1] for k in usable_ace]
    y1 = [k[0] for k in usable_ace]
    ...
    x2 = [k[1] for k in nonusable_ace]
    y2 = [k[0] for k in nonusable_ace]
